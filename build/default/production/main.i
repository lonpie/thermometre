...
unsigned int read_data(char pin){
    ...
    TMR0 = 0x00;
    while ((PORTA & pin) != 0 && TMR0 < 110){__nop();}
    ...
    while ((PORTA & pin) == 0 && TMR0 < 100 ){__nop();}
   ...
   return data_r;
    ...
    while ((PORTA & pin) != 0 && TMR0 < 200){__nop();}
